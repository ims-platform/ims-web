...
export function TeacherRegistrationForm() {
  ...
  const {
    ...
    resolver: zodResolver(
      registrationSchema as unknown as Parameters<typeof zodResolver>[0],
    ) as unknown as Resolver<RegistrationFormValues>,
    defaultValues: {
      fullName: '',
      email: '',
      specialty: '',
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="relative py-4">
        ...
        <div className="text-xxs relative flex justify-center font-bold tracking-widest uppercase">
